...
<body>
    <h1 id="loginStatus">Du är <?php if($_SESSION['loggedIn']): echo 'inloggad <a href="logout.php"><br>Logga ut</a>'; else: echo 'utloggad <a href="login.php"><br>Logga in</a>'; endif;?></h1>
 <div class="indexBox">
     <p>Meny</p>
